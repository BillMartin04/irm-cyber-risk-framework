---
description: MITRE ATT&CK Framework Mapping for Control Gap Analysis
---

# 8.3 · MITRE ATT&CK Framework Mapping for Control Gap Analysis

{% hint style="success" %}
**Module 8: Incident Response** — 4LOD: 1st Line (Incident Responders) & 4th Line (Crisis Leadership) · Persona: Incident Responders, SOC Managers, Business Continuity Planners
{% endhint %}

{% hint style="info" %}
### 📺 Watch on YouTube

**Video title:** *MITRE ATT&CK Framework Mapping for Control Gap Analysis — Incident Response Plan (2026)*
...
This lesson covers **MITRE ATT&CK Framework Mapping for Control Gap Analysis** as part of the Incident Response module. The line-of-defense frame for this material is 1st Line (Incident Responders) & 4th Line (Crisis Leadership), which is why the primary audience is Incident Responders. Practitioners in adjacent lines of defense should also work through it — the biggest failure mode of a GRC program is when one line assumes another line has covered a control it has not.
...
[← 8.2 Incident Response Lifecycle: Preparation, Detection, Containment, Eradication, Recovery](lesson-8-2.md) · [8.4 Tabletop Exercise Design: Scenarios, Facilitation, and Scoring →](lesson-8-4.md)
