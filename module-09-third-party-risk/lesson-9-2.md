---
description: Standardized Information Gathering (SIG) and CAIQ Assessments
---

# 9.2 · Standardized Information Gathering (SIG) and CAIQ Assessments
...
**Video title:** *Standardized Information Gathering (SIG) and CAIQ Assessments — Third Party Risk Management Tprm (2026)*
...
[← 9.1 Vendor Due Diligence and Inherent Risk Tiering](lesson-9-1.md) · [9.3 Contractual Security Clauses, Right to Audit, and SLA Governance →](lesson-9-3.md)
