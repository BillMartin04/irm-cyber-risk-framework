---
description: High-Risk Employee Identification and Tailored Coaching
---

# 16.3 · High-Risk Employee Identification and Tailored Coaching

{% hint style="success" %}
**Module 16: Human Cyber Risk** — 4LOD: 1st Line (Employee Behavior) & 2nd Line (Awareness Program Oversight) · Persona: Security Awareness Program Managers, Culture Leads, HR Risk Partners
{% endhint %}

{% hint style="info" %}
### 📺 Watch on YouTube

**Video title:** *High-Risk Employee Identification and Tailored Coaching — Security Awareness Training (2026)*
...
This lesson covers **High-Risk Employee Identification and Tailored Coaching** as part of the Human Cyber Risk module. The line-of-defense frame for this material is 1st Line (Employee Behavior) & 2nd Line (Awareness Program Oversight), which is why the primary audience is Security Awareness Program Managers. Practitioners in adjacent lines of defense should also work through it — the biggest failure mode of a GRC program is when one line assumes another line has covered a control it has not.
...
[← 16.2 Phishing and Social Engineering Simulation Governance](lesson-16-2.md) · [16.4 Security Champions Programs: Scaling GRC into Engineering and Business Units →](lesson-16-4.md)
