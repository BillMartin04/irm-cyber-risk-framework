---
description: CI/CD Pipeline Security and Policy-as-Code (DevSecOps)
---

# 13.5 · CI/CD Pipeline Security and Policy-as-Code (DevSecOps)
...
**Video title:** *CI/CD Pipeline Security and Policy-as-Code (DevSecOps) — Cloud Security Aws Azure Gcp (2026)*
...
[← 13.4 Container, Kubernetes, and Serverless Security Governance](lesson-13-4.md) · [Next: Module 14 · Regulatory Resilience →](../module-14-regulatory-resilience/README.md)
