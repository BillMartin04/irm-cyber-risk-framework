---
description: Cloud Security Posture Management (CSPM) and Drift Detection
---

# 13.2 · Cloud Security Posture Management (CSPM) and Drift Detection

{% hint style="success" %}
**Module 13: Cloud Security Governance** — 4LOD: 1st Line (DevSecOps Execution) & 2nd Line (Cloud Policy Baselines) · Persona: Cloud Security Architects, DevSecOps Leads, Infrastructure Compliance Engineers
{% endhint %}

{% hint style="info" %}
### 📺 Watch on YouTube

**Video title:** *Cloud Security Posture Management (CSPM) and Drift Detection — Cloud Security Aws Azure Gcp (2026)*
...
This lesson covers **Cloud Security Posture Management (CSPM) and Drift Detection** as part of the Cloud Security Governance module. The line-of-defense frame for this material is 1st Line (DevSecOps Execution) & 2nd Line (Cloud Policy Baselines), which is why the primary audience is Cloud Security Architects. Practitioners in adjacent lines of defense should also work through it — the biggest failure mode of a GRC program is when one line assumes another line has covered a control it has not.
...
[← 13.1 Cloud Shared Responsibility Models (IaaS, PaaS, SaaS)](lesson-13-1.md) · [13.3 Multi-Cloud Compliance: AWS Well-Architected, Azure Security Benchmark, GCP →](lesson-13-3.md)
