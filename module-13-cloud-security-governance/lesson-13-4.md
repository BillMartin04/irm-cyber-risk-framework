---
description: Container, Kubernetes, and Serverless Security Governance
---

# 13.4 · Container, Kubernetes, and Serverless Security Governance
...
**Video title:** *Container, Kubernetes, and Serverless Security Governance — Cloud Security Aws Azure Gcp (2026)*
...
[← 13.3 Multi-Cloud Compliance: AWS Well-Architected, Azure Security Benchmark, GCP](lesson-13-3.md) · [13.5 CI/CD Pipeline Security and Policy-as-Code (DevSecOps) →](lesson-13-5.md)
