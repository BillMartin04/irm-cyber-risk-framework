---
description: Cloud Shared Responsibility Models (IaaS, PaaS, SaaS)
---

# 13.1 · Cloud Shared Responsibility Models (IaaS, PaaS, SaaS)
...
**Video title:** *Cloud Shared Responsibility Models (IaaS, PaaS, SaaS) — Cloud Security Aws Azure Gcp (2026)*
...
[← Module 13 Overview](README.md) · [13.2 Cloud Security Posture Management (CSPM) and Drift Detection →](lesson-13-2.md)
