---
description: Calculating Loss Event Frequency (LEF) and Threat Event Frequency (TEF)
---

# 10.3 · Calculating Loss Event Frequency (LEF) and Threat Event Frequency (TEF)
...
**Video title:** *Calculating Loss Event Frequency (LEF) and Threat Event Frequency (TEF) — Fair Risk Quantification (2026)*
...
[← 10.2 Factor Analysis of Information Risk (FAIR) Framework Architecture](lesson-10-2.md) · [10.4 Modeling Loss Magnitude: Primary vs Secondary Losses →](lesson-10-4.md)
