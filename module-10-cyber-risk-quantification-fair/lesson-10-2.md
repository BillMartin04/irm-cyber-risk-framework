---
description: Factor Analysis of Information Risk (FAIR) Framework Architecture
---

# 10.2 · Factor Analysis of Information Risk (FAIR) Framework Architecture

{% hint style="success" %}
**Module 10: FAIR Quantification** — 4LOD: 2nd Line (Quantitative Risk) & 4th Line (Board Capital Decisions) · Persona: Senior Risk Analysts, Quantitative Modelers, CISO Advisors
{% endhint %}

{% hint style="info" %}
### 📺 Watch on YouTube

**Video title:** *Factor Analysis of Information Risk (FAIR) Framework Architecture — Fair Risk Quantification (2026)*
...
This lesson covers **Factor Analysis of Information Risk (FAIR) Framework Architecture** as part of the FAIR Quantification module. The line-of-defense frame for this material is 2nd Line (Quantitative Risk) & 4th Line (Board Capital Decisions), which is why the primary audience is Senior Risk Analysts. Practitioners in adjacent lines of defense should also work through it — the biggest failure mode of a GRC program is when one line assumes another line has covered a control it has not.
...
[← 10.1 Limitations of Qualitative High/Medium/Low Heat Maps](lesson-10-1.md) · [10.3 Calculating Loss Event Frequency (LEF) and Threat Event Frequency (TEF) →](lesson-10-3.md)
