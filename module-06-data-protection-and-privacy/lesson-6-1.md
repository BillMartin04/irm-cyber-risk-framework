---
description: Data Discovery and Classification Tiers (Public, Internal, Confidential, Restricted)
---

# 6.1 · Data Discovery and Classification Tiers (Public, Internal, Confidential, Restricted)

{% hint style="success" %}
**Module 6: Data Protection & Privacy** — 4LOD: 2nd Line (Data Governance & Compliance Policy) · Persona: Data Protection Officers, Privacy Analysts, InfoSec Policy Leads
{% endhint %}

{% hint style="info" %}
### 📺 Watch on YouTube

**Video title:** *Data Discovery and Classification Tiers (Public, Internal, Confidential, Restricted) — Gdpr Compliance (2026)*
...
This lesson covers **Data Discovery and Classification Tiers (Public, Internal, Confidential, Restricted)** as part of the Data Protection & Privacy module. The line-of-defense frame for this material is 2nd Line (Data Governance & Compliance Policy), which is why the primary audience is Data Protection Officers. Practitioners in adjacent lines of defense should also work through it — the biggest failure mode of a GRC program is when one line assumes another line has covered a control it has not.
...
[← Module 6 Overview](README.md) · [6.2 Data Handling, Retention Schedules, and Sanitization Standards →](lesson-6-2.md)
