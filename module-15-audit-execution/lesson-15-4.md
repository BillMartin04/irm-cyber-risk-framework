...
**Video title:** *Writing Audit Findings: Condition, Criteria, Cause, Effect, Recommendation — Internal Audit Cybersecurity (2026)*
...
[← 15.3 Control Testing: Design Effectiveness (TOD) vs Operating Effectiveness (TOE)](lesson-15-3.md) · [15.5 Corrective Action Plans (CAP) and Remediation Tracking →](lesson-15-5.md)
